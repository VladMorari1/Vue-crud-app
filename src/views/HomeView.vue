        ...
        <form @submit.prevent="addNewRecipe">
          ...
          <div class="group">
            ...
            <div class="method" v-for="i in newRecipe.methodRows" :key="i">
              <textarea type="text" v-model="newRecipe.method[i-1]"/>
            </div>
            <button type="button" @click="addNewMStep">Add step</button>
          </div>
...
export default {
  ...
  setup() {
    ...
    return {newRecipe, popupOpen, togglePopup, addNewIngredient, addNewMStep, addNewRecipe}
  },
